    		...
    		this.$http.get('active/getEnjoyActiveByUserId',{
    			...
    			this.list.forEach(item =>{
    				    ...
    				    for(let i=0;i<item.pictures.length;i++){
	    					var obj = {};
	    					obj.msrc = 'http://dj.dlbdata.cn/dangjian/picture/showThumbnail?pictureId='+item.pictures[i].pictureId;
	    					obj.src = 'http://dj.dlbdata.cn/dangjian/picture/show?pictureId='+item.pictures[i].pictureId;
