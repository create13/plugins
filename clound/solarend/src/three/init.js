...
const init = (() => {
  ...
  const initFunc = {
    ...
    initAmbientLight () {
      const ambient = new THREE.AmbientLight(0xf8f8f8, 0.5);
      return ambient;
    },
    initSpotLight () {
      const spot = new THREE.SpotLight(0xff0000, 2, 20000);
  ...
  return (options = {}) => {
    ...
    const controls = initFunc.initControls(camera, renderer, options.controls, three);
